...
const App: React.FC = () => {
  return (
    <div className="flex flex-col min-h-screen">
      {/* Header */}
      <header className="bg-poke-red p-6 shadow-lg border-b-8 border-poke-dark">
        <div className="container mx-auto flex items-center justify-between">
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 bg-white rounded-full border-4 border-poke-dark flex items-center justify-center relative overflow-hidden">
      ...
      <main className="flex-grow container mx-auto px-4 py-12 flex flex-col items-center justify-center">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-4xl">
          ...
          {/* Menu 1: MBTI Test */}
          <button className="group relative bg-white rounded-3xl p-8 border-8 border-poke-yellow shadow-[0_10px_0_0_rgba(255,203,5,1)] hover:translate-y-1 hover:shadow-none transition-all duration-200">
            <div className="flex flex-col items-center gap-4 text-poke-dark">
              ...
              <div className="mt-4 px-6 py-2 bg-poke-yellow text-poke-dark font-black rounded-full text-sm uppercase">MBTI Test</div>
            </div>
            {/* Pokéball decor */}
          ...
          <button className="group relative bg-white rounded-3xl p-8 border-8 border-poke-red shadow-[0_10px_0_0_rgba(238,21,21,1)] hover:translate-y-1 hover:shadow-none transition-all duration-200">
            <div className="flex flex-col items-center gap-4 text-poke-dark">
              <div className="text-6xl mb-2">⚡</div>
              <h2 className="text-2xl font-black uppercase">실시간 스피드 계산기</h2>
              <p className="font-bold text-gray-600">누가 먼저 공격할까?</p>
              <div className="mt-4 px-6 py-2 bg-poke-red text-white font-black rounded-full text-sm uppercase">Speed Calc</div>
            </div>
            {/* Pokéball decor */}
