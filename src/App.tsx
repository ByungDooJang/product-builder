    ...
    <div className="flex flex-col min-h-screen">
      <header className="bg-poke-red p-6 shadow-lg border-b-8 border-poke-dark sticky top-0 z-50">
        <div className="container mx-auto flex items-center justify-between">
          <div className="flex items-center gap-4 cursor-pointer active:scale-95 transition-transform" onClick={() => setView('home')}>
      ...
      <main className="flex-grow container mx-auto px-4 py-12 flex flex-col items-center justify-center">
        ...
        {view === 'home' && (
          <div className="mt-16 bg-white/10 backdrop-blur-md p-8 rounded-2xl border-2 border-white/20 max-w-2xl text-center">
            <p className="text-lg font-medium text-gray-300 italic">"포켓몬 배틀의 승리를 위한 최고의 파트너!"</p>
          </div>
        )}
      </main>
